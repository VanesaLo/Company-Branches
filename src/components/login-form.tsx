          ...
          <form className="p-6 md:p-8" action={formAction}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" className="w-full" onClick={(e) => handleBtnLoginWith(e, "Apple")}>
                ...
                <Button variant="outline" className="w-full" onClick={(e) => handleBtnLoginWith(e, "Google")}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                ...
                <Button variant="outline" className="w-full" onClick={(e) => handleBtnLoginWith(e, "Meta")}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
